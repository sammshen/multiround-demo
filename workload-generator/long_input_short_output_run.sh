...
if [[ $# -lt 2 ]]; then
    echo "Usage: $0 <model> <save file key> [qps_values...]"
    echo "Example: $0 meta-llama/Llama-3.1-8B-Instruct /mnt/requests/synthetic-run1 0.1 0.2 0.3"
    exit 1
fi
